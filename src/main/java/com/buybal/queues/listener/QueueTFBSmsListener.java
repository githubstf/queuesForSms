 ...
 *
 */
public class QueueTFBSmsListener implements MessageListener{
    private final static Logger logger = Logger.getLogger(QueueTFBSmsListener.class);
	...
	public void onMessage(Message message){
        if(message instanceof ObjectMessage){
            ...
            try{
        		...
        		sendSmsService.sendSMSForTFB(map.get("mobiles"), map.get("message"));
                Thread.sleep(1000);
