 ...
 *
 */
public class QueueMDSmsListener implements MessageListener{
    private final static Logger logger = Logger.getLogger(QueueMDSmsListener.class);
	...
	public void onMessage(Message message){
        if(message instanceof ObjectMessage){
            ...
            try{
        		...
        		sendSmsService.sendSMSForMD(map.get("mobiles"), map.get("message"), null,dateTime,null);
                Thread.sleep(1000);
