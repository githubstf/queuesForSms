 ...
 *
 */
public class QueueYTBSmsListener implements MessageListener{
    private final static Logger logger = Logger.getLogger(QueueYTBSmsListener.class);
	...
	public void onMessage(Message message){
        if(message instanceof ObjectMessage){
            ...
            try{
        		...
        		sendSmsService.sendSMSForYTB(map.get("mobiles"), dateTime, map.get("message"));
                Thread.sleep(1000);
